...
> Auto-generated by `lore export` on 2026-03-29. Do not edit manually — use `lore add` to update.
...
- fix: signals page stats - beacon count from _liveBeacons, today count from signals API, meta parse robustness

- Beacon count reads window._liveBeacons (same source as SITREP/war room)
